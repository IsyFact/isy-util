...
Um in den verschiedenen Anwendungen einheitlichen Textausgaben zu erzeuge, etwa bei Fehlermeldungen und Log-Ausgaben, befinden sich im Unterpaket `text` Methoden zu Erzeugung parametrisierbarer Texte. Dies sind:
