...
public final class MessageSourceHolder implements MessageSourceAware {
     ...
     *
     * @param schluessel der Schlüssel des Resource-Bundles
     * @param parameter  der Wert für die zu ersetzenden Platzhalter
     ...
     * @param schluessel der Schlüssel des Resource-Bundles
     * @param parameter  der Wert für die zu ersetzenden Platzhalter
     * @param locale     die Sprache der Nachricht
     * @return die Nachricht
     */
     ...
     * Setter für Spring.
     *
     * @param messageSource MessageSource-Bean der Anwendung.
     */
