...
public class RecursiveToStringBuilder {
     ...
     * Rekursive Ausgabe von Objekten.
     *
     * @param prefix Das Ausgabe-Präfix
     * @param o      Das zu schreibende Objekt
     * @param buffer Der StringBuilder
     * @param seen   Rückreferenzen
     */
     ...
     *
     * @param prefix Das Ausgabe-Präfix
     * @param o      Das zu schreibende Array-Objekt
     * @param buffer Der StringBuilder
     * @param seen   Rückreferenzen
     */
     ...
     *
     * @param prefix Das Ausgabe-Präfix
     * @param o      Das zu schreibende Iterable-Objekt
     * @param buffer Der StringBuilder
     * @param seen   Rückreferenzen
     */
     ...
     *
     * @param prefix Das Ausgabe-Präfix
     * @param o      Das zu schreibende Map-Objekt
     * @param buffer Der StringBuilder
     * @param seen   Rückreferenzen
     */
     ...
     *
     * @param o Das zu prüfende Objekt
     ...
     *
     * @param o      Das zu schreibende Objekt
     * @param buffer Der StringBuilder der für die Ausgabe verwendet werden soll
     */
